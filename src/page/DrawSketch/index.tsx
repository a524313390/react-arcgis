...
export default function DrawSketch() {
    ...
    return (
        <>
            <Space>
                <Button type="primary" onClick={() => draw('point')}>绘制点</Button>
                <Button type="primary" onClick={() => draw('polyline')}>绘制线</Button>
                <Button type="primary" onClick={() => draw('rectangle')}>绘制矩形</Button>
                <Button type="primary" onClick={() => draw('polygon')}>绘制面</Button>
                <Button type="primary" onClick={() => draw('circle')}>绘制园</Button>
            </Space>
